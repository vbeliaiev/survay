...
ActiveRecord::Schema.define(version: 20160503193939) do
  ...
  add_index "selected_variants", ["answer_id"], name: "index_selected_variants_on_answer_id", using: :btree
  ...
  add_foreign_key "selected_variants", "answers"
